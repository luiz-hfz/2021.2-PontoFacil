...
<table>
    ...
    <tbody >
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);">Eu, como um usuário do sistema, desejo inserir o saldo de horas já existente para que possa controlar as horas trabalhadas.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);" rowspan="3"><a href="#epico-02" >Épico 02 - Backup </a></td>
...
|US07 |RF07 | poder inserir o saldo de horas já existente | possa controlar as horas trabalhadas | Should |
|US08 |RF08 | poder registrar o ponto de retorno do almoço |eu saiba  quando eu voltei do almoço  | Must |
|US09 |RF13 | poder registrar o ponto eletrônico através de uma Tag NFC | eu tenha mais praticidade e agilidade no registro  | Would |
|US10 |RF15 | poder zerar o saldo de horas total | eu possa recomeçar os registros do zero | Should |
|US11 |RF17 | poder registrar falta |  eu saiba quando eu faltei  | Should |
|US12 |RF18 | poder adicionar uma foto do registro do ponto |tenha certeza que registrei o ponto  | Should |
|US13 |RF23 | poder apagar todos os registros | eu possa apagar tudo que registrei | Must |
|US14 |RF26 | poder registrar folga |  eu saiba quando eu folguei | Should |
|US15 |RF29 | poder editar registros passados |possa corrigir erros que cometi | Should |
|US16 |RF30 | poder registrar férias |  eu saiba quando eu entrei de férias | Should |
...
| US ID| Requisito | Eu,como usuário gostaria de... |Para que...| Prioridade|
| :---: | :---: | :---: |:---: |:---: |
|US19 |RF10 |  poder configurar o horário e o dia do backup | eu tenha sempre os backups atualizados de forma automática| Would |
|US20 |RNF07 | poder armazenar o backup em contas do Google Drive ou Dropbox |eu tenha os meus dados salvos em nuvem  | Could |
|US21 |RF28 | poder fazer  backup dos meus registros automaticamente em nuvem ou local | eu tenha mais de um tipo de cópia de segurança | Could |
